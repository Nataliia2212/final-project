...
const textMessage = "It appears that you haven't added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future."
...
function render(data) {
  if (data.length === 0) {
    favoritesRef.innerHTML = textMessage;
  } else {
